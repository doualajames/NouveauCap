        ...
        {activeTab === 'stats' && (
          <div className="space-y-6">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <Card className="border border-border shadow-none bg-primary text-primary-foreground"><CardContent className="p-4"><p className="text-sm opacity-80">{language === 'fr' ? 'Utilisateurs' : 'Users'}</p><p className="text-3xl font-bold">{stats.totalUsers.toLocaleString()}</p></CardContent></Card>
              <Card className="border border-border shadow-none bg-primary text-primary-foreground"><CardContent className="p-4"><p className="text-sm opacity-80">{language === 'fr' ? 'Actifs (30j)' : 'Active (30d)'}</p><p className="text-3xl font-bold">{stats.activeUsers.toLocaleString()}</p></CardContent></Card>
              <Card className="border border-border shadow-none bg-primary text-primary-foreground"><CardContent className="p-4"><p className="text-sm opacity-80">Premium</p><p className="text-3xl font-bold">{stats.premiumSubscribers}</p></CardContent></Card>
              <Card className="border border-border shadow-none bg-primary text-primary-foreground"><CardContent className="p-4"><p className="text-sm opacity-80">{language === 'fr' ? 'Revenus/mois' : 'Revenue/mo'}</p><p className="text-3xl font-bold">${stats.monthlyRevenue.toFixed(0)}</p></CardContent></Card>
            </div>
            <div className="grid lg:grid-cols-2 gap-6">
              <Card className="border border-border shadow-none">
                <CardHeader><CardTitle className="flex items-center gap-2"><TrendingUp className="w-5 h-5 text-foreground" />{language === 'fr' ? 'Inscriptions (7 jours)' : 'Signups (7 days)'}</CardTitle></CardHeader>
                <CardContent>
