...
export function ProvinceModule({ language, user }: {
  ...
  const sections = [
    { key: 'welcomeProgram', icon: HeartHandshake, label: language === 'fr' ? 'Programme d\'accueil' : 'Welcome Program', color: ' ' },
    { key: 'employment', icon: Briefcase, label: language === 'fr' ? 'Emploi et formation' : 'Employment & Training', color: ' ' },
    { key: 'language', icon: Globe, label: language === 'fr' ? 'Cours de langue' : 'Language Classes', color: ' ' },
    { key: 'settlement', icon: Home, label: language === 'fr' ? 'Services d\'établissement' : 'Settlement Services', color: ' ' },
  ]
      ...
      <div className="p-4 lg:p-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-primary text-primary-foreground rounded-2xl flex items-center justify-center shadow-none shadow-cyan-200 dark:shadow-cyan-900/30">
        ...
        <div className="bg-primary text-primary-foreground rounded-2xl p-6 border border-border border-border">
              ...
              <Card key={section.key} className="border border-border shadow-none bg-card/80 backdrop-blur-sm overflow-hidden hover:shadow-none transition-all duration-300">
                ...
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center gap-2 text-lg">
                    <div className={`w-8 h-8 bg-muted ${section.color} rounded-lg flex items-center justify-center`}>
            ...
            <CardContent>
              {policies.financialAid.amount && (
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-semibold text-muted-foreground text-muted-foreground">
        ...
        {/* Important Notes */}
        <Card className="border border-border shadow-none bg-muted bg-muted">
