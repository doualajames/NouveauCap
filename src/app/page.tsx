    ...
    <div className="bg-background text-foreground">
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 sm:py-24 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/app"
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-foreground px-7 py-4 text-base font-semibold text-background transition-opacity hover:opacity-90"
              >
            ...
            <ul className="mt-4 space-y-3 text-sm">
              {[
                ...
                <li key={i} className="flex items-center gap-3">
                  <span className={`flex h-5 w-5 flex-none items-center justify-center rounded ${x.done ? 'bg-foreground text-background' : x.urgent ? 'border-2 border-destructive' : 'border-2 border-foreground/60'}`}>
                    {x.done ? '✓' : ''}
                  </span>
      ...
      <section className="border-t border-foreground/80 bg-foreground text-background">
        <div className="mx-auto max-w-3xl px-6 py-16">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-background/60">Gratuit, par courriel</p>
