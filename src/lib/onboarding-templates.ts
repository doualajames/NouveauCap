// Corpus des parcours d'onboarding — source canonique versionnée.
// La base (table TaskTemplate) est peuplée depuis ce module par prisma/seed.ts ;
// l'API lit la base et retombe sur ce module si la table est vide.

// Province-specific task templates
export const provinceSpecificTasks: Record<string, Record<string, any[]>> = {
  // Ontario
  'ON': {
    PERMANENT_RESIDENT: [
      { 
